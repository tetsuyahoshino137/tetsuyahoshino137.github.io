...
<div class="profile">
  <div class="profile-info">
    ...
    <p>{{ site.position }}</p>
    <ul>
      <li><strong><a href="TetsuyaHoshinoCV260510.pdf">CV (26-05-10)</a></strong></li>
      <li>
        <strong>Email:</strong>
        <span>
                          <code>{{ site.email | replace: "@", "[at]" }}</code>
